...
type
  //*****************************DECLARAÇÕES*********************************///
  TDllGetCertificadoDigital = function : PAnsiChar; stdcall;
  ...
  TDllSetCertificadoDigital = procedure (CertSerialNumber: AnsiString); stdcall;
  ...
  TDownloadXMLNFeDLL = Class
    ...
    public
      ...
      function GetCertificadoDigital: String; 
      function Msg: String; 
      procedure SetCertificadoDigital(CertSerialNumber: String);
...
function TDownloadXMLNFeDLL.GetCertificadoDigital: String;
  var
...
procedure TDownloadXMLNFeDLL.SetCertificadoDigital(
